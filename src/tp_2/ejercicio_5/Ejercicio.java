...
import tp_2.ejercicio_4.RedBinariaLlena;
...
public class Ejercicio {
	...
	public static void main(String[] args) {
		...
		ProfundidadArbol profundidadArbol = new ProfundidadArbol(raiz);
		...
		int resultado = profundidadArbol.sumaElementosProfundidad(3);
